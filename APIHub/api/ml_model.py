...
class MLModel: 
    def __init__(self,model_path, region_encoder_path, supplier_encoder_path, description_model_path): # Загрузка модели при инициализации 
    ...
    def predict(self, data): #Преобразование входных данных и выполнение предсказания 
